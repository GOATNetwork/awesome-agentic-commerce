...
- **[GPT55 x402 Agent Tools](https://gpt55.558686.xyz)** — Remote x402 MCP/API gateway for OpenAI-compatible chat request shape plus deterministic URL, HTTP, JSON, text, and x402 seller utilities. Exposes Base USDC settlement, OpenAPI, AgentCard, agents402, MCP discovery, pricing metadata, and an editorial-safe directory listing at https://gpt55.558686.xyz/directory-listing.json.
