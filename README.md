...
- **[Anthropic Claude as AI Travel Agent (Crossmint MCP)](https://www.crossmint.com/blog/agentic-commerce)** — Natural-language conversation to research, compare, and book flights autonomously via Crossmint payments (USDC on Solana or cards).
- **[Flight Deal Sniper Agents (Crossmint-powered)](https://www.crossmint.com/blog/agentic-commerce)** — Set criteria (e.g., "NYC–London under $400, max 1 stop"). The agent monitors daily price changes across platforms and auto-purchases when thresholds are met.
...
- **[H&M Agentic Layout & Virtual Assistant](https://hmgroup.com/news/hm-group-annual-report-2024/)** — Tracks foot traffic/purchases and auto-optimizes store merchandising while handling shopping/returns. Reported improvements in basket size and conversion rates.
